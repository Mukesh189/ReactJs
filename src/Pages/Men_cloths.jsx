      ...
      <div className="col-lg-9 col-md-8">
        <div className="row pb-3">
            ...
            <div className="product-item bg-light mb-4">
              ...
              <div className="text-center py-4">
                ...
                <div className="d-flex align-items-center justify-content-center mt-2">
                  <h5>$599.00</h5><h6 className="text-muted ml-2"><del>$599.00</del></h6>
                </div>
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 pb-1">
            <div className="product-item bg-light mb-4">
              <div className="product-img position-relative overflow-hidden" style={{width: 295, height: 400}}>
                <img className="img-fluid w-100" src="https://img.freepik.com/free-photo/young-entrepreneur-wearing-shirt-trousers_651396-3032.jpg?size=626&ext=jpg&ga=GA1.1.583727593.1658979819&semt=ais" alt />
              
              </div>
              <div className="text-center py-4">
                <a className="h6 text-decoration-none text-truncate" href> Printed Shirt</a>
                <div className="d-flex align-items-center justify-content-center mt-2">
                  <h5>$299.00</h5><h6 className="text-muted ml-2"><del>$399.00</del></h6>
                </div>
                <div className="d-flex align-items-center justify-content-center mb-1">
                  <small className="fa fa-star text-primary mr-1" />
                  <small className="fa fa-star text-primary mr-1" />
          ...
          <div className="col-lg-4 col-md-6 col-sm-6 pb-1">
            <div className="product-item bg-light mb-4">
              <div className="product-img position-relative overflow-hidden"  style={{width: 295, height: 400}}>
                <img className="img-fluid w-100" src="https://img.freepik.com/premium-photo/style-everyday-mens-casual-shirt-photoshoot-poses-boys-shirt_463958-101.jpg?size=626&ext=jpg&ga=GA1.1.583727593.1658979819&semt=ais" alt />
          
              </div>
              <div className="text-center py-4">
                <a className="h6 text-decoration-none text-truncate" href>Maroon Plan Shirt</a>
                <div className="d-flex align-items-center justify-content-center mt-2">
